School::Application.configure do
  ...
  config.assets.precompile += %w(app_bootstrap.css colorful.css jquery.rater.css fancybox/*.css fancybox/*.js datepicker.css colorful.js rails.validations.js rails.validations.simple_form.js     bootstrap-datepicker.js bootstrap-datepicker.zh-CN.js jquery.rater.js colorful_main.css colorful_weixin.css colorful_responsive.css scaffolds.css active_admin.css colorful_weixin.js jquery.jcarouselLite.js jquery.validate.js DD_belatedPNG_0.0.8a.js jquery.timers.js jquery.slideViewerPro.js svwp_style.css css/*.css js/jquery.timelinr-0.9.53.js jquery.lettering.js rails.validations.customValidators.js)
end
