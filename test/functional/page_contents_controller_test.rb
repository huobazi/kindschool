...
class PageContentsControllerTest < ActionController::TestCase
  ...
  test "should create page_content" do
    assert_difference('PageContent.count') do
      post :create, page_content: { kindergarten_id: @page_content.kindergarten_id, name: @page_content.name, number: @page_content.number }
    end
  ...
  test "should update page_content" do
    put :update, id: @page_content, page_content: { kindergarten_id: @page_content.kindergarten_id, name: @page_content.name, number: @page_content.number }
    assert_redirected_to page_content_path(assigns(:page_content))
  end
